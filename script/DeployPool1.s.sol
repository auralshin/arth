...
contract DeployPool1 is BasePoolDeployment {
    function run() external {
        ...
        // Pool 1: wstETH/USDC 1M maturity
        ...
        (PoolId poolId, address hook) = deployPool(
            ...
            maturity,
            "Pool 1: wstETH/USDC 1M",
            1 // Salt start - unique for Pool 1
        );
        
        vm.stopBroadcast();
        
        console2.log("=== Pool 1 Deployment Complete ===");
