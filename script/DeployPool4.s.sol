...
contract DeployPool4 is BasePoolDeployment {
    function run() external {
        ...
        // Pool 4: wstETH/PYUSD 3M maturity
        ...
        (PoolId poolId, address hook) = deployPool(
            ...
            maturity,
            "Pool 4: wstETH/PYUSD 3M",
            300000 // Salt start - unique for Pool 4
        );
        
        vm.stopBroadcast();
        
        console2.log("=== Pool 4 Deployment Complete ===");
